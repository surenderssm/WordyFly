    ...
    public class GameSession : INotifyPropertyChanged
    {
        ...
        public int TimesTicked
        {
            ...
            set
            {
                ...
                {
                    TimerString = ((timesToTick-timesTicked) / 60).ToString() + ":0" + ((timesToTick - timesTicked) % 60).ToString();
                }
                else
                {
                    TimerString = ((timesToTick - timesTicked) / 60).ToString() + ":" + ((timesToTick - timesTicked) % 60).ToString();
                }
